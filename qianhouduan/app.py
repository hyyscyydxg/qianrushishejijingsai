...
import tos
# ----------------- 配置参数 -----------------
RTSP_SOURCE  = "rtsp://admin:GU622723@192.168.1.64:554/Streaming/Channels/101"
STATIC_DIR   = "static"
...
TOS_ACCESS_KEY = "AKLTZGJlZWE4YThiYjIyNDNjZGIzZTkxOTI5MjdlOWQ2NzQ"
TOS_SECRET_KEY = "Wm1ZeE16WTFNRE0yWXpSaE5HWmxaR0V3TkdOa09HVXdNMkptWTJVMU16aw=="
TOS_ENDPOINT   = "tos-cn-shanghai.volces.com"
TOS_PREFIX   = "clips/" + datetime.now().strftime("%Y%m%d")
SK_Key="sk-5324177fc3694d4bb1d7851421052ebe8vmujusizv587kvk"
ARK_API_KEY  = "5362e52d-15ec-4a7d-8973-fadf2d897cb2"
...
RTC_APP_KEY  = "2c8b0e626a744916b64abf5398e9f15a"
...
def start_ffmpeg_record():
    ...
    cmd = [
        "ffmpeg", "-rtsp_transport", "tcp", "-i", RTSP_SOURCE,
        "-c:v", "libx264", "-preset", "ultrafast", "-tune", "zerolatency",  # ✅ 强制编码确保关键帧
        "-c:a", "aac",                                                     # ✅ 添加音轨避免音视频结构不完整
        "-f", "mpegts",                                                    # ✅ 写入 TS 流
        RECORD_FILE
    ]
